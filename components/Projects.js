...
const Projects = () => {
  ...
  return (
    <div className="md:w-9/12 mx-auto py-8">
      ...
      >
        <div className="flex justify-center items-center bg-gray-600/25 ring-1 ring-gray-700 rounded-2xl  backdrop-blur-lg div-5 col-span-5 md:col-span-3 p-5">
          <Image
            src={library}
            alt=""
      ...
      <motion.div
        ...
        viewport={{ once: true, amount: 0.1 }}
        variants={projectVariants}
        className="flex flex-col lg:flex-row items-center justify-center my-16 div-6 md:div-10 bg-slate-600/20 ring-1 ring-blue-400/20 rounded-2xl  backdrop-blur-sm"
      >
        ...
        <div>
          ...
          <div className="bg-white/5 div-4 text-small_text ring-1 ring-slate-50/40 rounded ml-3 mt-4">
            {" "}
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi
            distinctio harum perspiciatis libero facilis dolorum quisquam sed
            omnis, atque obcaecati animi qui sint sunt ipsam est eius doloremque
          ...
          <div className="flex flex-wrap items-center text-primary text-sm font-semibold justify-end mt-3">
            <span className="mr-3">React</span>
